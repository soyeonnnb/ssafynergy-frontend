          ...
          <div class="form sign-up">
            ...
            <div class="input-group">
              ...
              <input
                ...
                required
              />
              <i class="fa-solid fa-check" v-if="passwordCheckInfo"></i>
            </div>
            <div class="input-group">
            ...
            <button @click="regist">SIGN UP</button>
            <p>
  ...
  methods: {
    ...
    passwordIsSame() {
      if (this.password.length === 0 || this.passwordCheck.length === 0) {
        this.passwordCheckInfo = false;
      } else if (this.password === this.passwordCheck) {
        this.passwordCheckInfo = true;
      } else {
        this.passwordCheckInfo = false;
      }
    },
